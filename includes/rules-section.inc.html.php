<h2 class="mobile-tablet">Important Info</h2>
<section id="rules">
    <!--Rules and FAQs-->
    <section>
    <h2 class="desktop">Important Info</h2>
    <h3 class="mobile-tablet">Rules and FAQs</h3>
        <ul>
        <h3 class="desktop">Rules and FAQs</h3>
            <li>
    ...
    <!--What to bring-->
    <section>
    <h3 class="mobile-tablet">What to Bring</h3>
        <ul>
        <h3 class="desktop">What to Bring</h3>
            <li>
                <p>
